...
uint8_t SENS  = 34; //чувствительность
...
uint32_t total_sec; // общее время работы
...
//CPS = SUMofCounts / total_sec;
// Динамическая сумма событий / общее время 

uint16_t  Radiation = (( SUMofCounts / total_sec) * SENS);
return Radiation;
